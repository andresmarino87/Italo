...
public class ImageAdapter extends BaseAdapter {
    ...
    public Integer[] mThumbIds = {
		com.italo_view.R.drawable.rutero,
		...
		com.italo_view.R.drawable.menu_principal_sincronizar,
    };

    public Integer[] strings = {
		com.italo_view.R.string.actividad_diaria_del_vendedor,
		...
		com.italo_view.R.string.sincronizar,
    };
